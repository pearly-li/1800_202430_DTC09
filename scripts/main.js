    ...
    upcomingEvents.forEach((eventDocID) => {
      db.collection("events")
        ...
        .then((doc) => {
          ...
          document
            .getElementById("upcoming_browsing_list")
            .appendChild(newCard);
        });
    });
  } else {
            ...
            .then((allEvents) => {
              allEvents.forEach((doc) => {
                if (eventIDs.includes(doc.id)) {
                  ...
                  newCard.querySelector(".schedule_card_title").innerHTML =
                    title;
                  newCard.querySelector(".schedule_card_date").innerHTML =
                    dateDisplay;
                  newCard.querySelector(".schedule_card_time").innerHTML =
                    formatTimeAgo(
                      dateDisplay,
                      todayEachComponent,
                      dateEachComponent
                  ...
                  document
                    .getElementById("user_event_schedule")
                    .appendChild(newCard);
                }
              });
            });
